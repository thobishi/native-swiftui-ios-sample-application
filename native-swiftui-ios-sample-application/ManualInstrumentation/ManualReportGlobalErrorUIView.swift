//
//  ManualReportGlobalErrorUIView.swift
...
struct ManualReportGlobalErrorUIView: View {
...
struct ManualReportGlobalErrorUIView_Previews: PreviewProvider {
    static var previews: some View {
        ManualReportGlobalErrorUIView()
    }
}
